...
namespace HeboTech.Fruits.Tests
{
    public class UnauthorizedResultTests
    {
        ...
        {
            UnauthorizedResult<object> result = new((string)null);

            Assert.Equal(ResultType.Unauthorized, result.ResultType);
        ...
        {
            UnauthorizedResult<object> result = new((List<string>)null);
        ...
        {
            UnauthorizedResult<object> result = new(new List<string> { "Error1", "Error2" });
