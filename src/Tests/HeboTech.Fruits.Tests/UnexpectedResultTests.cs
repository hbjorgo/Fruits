...
{
    public class UnexpectedResultTests
    {
        [Fact]
        public void Null_string_sets_defaults_test()
        {
            UnexpectedResult<object> result = new((string)null);
        ...
        {
            UnexpectedResult<object> result = new((List<string>)null);
        ...
        {
            UnexpectedResult<object> result = new(new List<string> { "Error1", "Error2" });
