...
namespace HeboTech.Fruits.Tests
{
    public class NotFoundResultTests
    {
        ...
        {
            NotFoundResult<object> result = new((string)null);
        ...
        {
            NotFoundResult<object> result = new((List<string>)null);
        ...
        {
            NotFoundResult<object> result = new(new List<string> { "Error1", "Error2" });
